...
fn main() {
    ...
    if std::env::var("PROFILE").as_deref() == Ok("debug") {
        ...
        println!("cargo:rustc-link-lib=absl_log_severity");
        println!("cargo:rustc-link-lib=absl_log_internal_message");
        println!("cargo:rustc-link-lib=absl_log_internal_nullguard");
    }
